...
let contentGridElement = document.getElementById('songs-grid');
...
let jsonDatabase = [
  {
    ...
    "picture_url" : "song-covers/akuou-thumbnail.jpg",
    "favorite_color" : [145, 12, 29],
...
function createElementProper(incomingJSON) {
  ...
  newContentElement.style.backgroundColor = "rgba(" + incomingJSON['favorite_color'] + ", 0.3)";
